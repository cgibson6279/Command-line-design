...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        metavar="",
        required=True,
        help="Seed for random shuffle generation",
    )
    parser.add_argument(
        "input", type=str, metavar="", help="Read all of the input data"
    )
    parser.add_argument(
        "train", type=str, metavar="", help="Path for writing the training set"
    )
    parser.add_argument(
        "dev", type=str, metavar="", help="Path for writing the dev set"
    )
    parser.add_argument(
        "test", type=str, metavar="", help="Path for writing the test set"
    )
